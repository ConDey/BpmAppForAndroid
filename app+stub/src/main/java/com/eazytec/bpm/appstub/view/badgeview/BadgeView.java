package com.eazytec.bpm.appstub.view.badgeview;

/**
 * @author 16735
 * @version Id: BadgeView, v 0.1 2017-8-17 18:03 16735 Exp $$
 */
...
public class BadgeView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void applyTo(View target) {
        ...
        if (target instanceof TabWidget) {
            ...
            LayoutParams targetLP = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
