package com.eazytec.bpm.appstub.view.timepick;
...
public class DatePickDialog extends Dialog implements OnChangeLisener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_cbk_dialog_pick_time);
    ...
    private void initView() {
        this.sure = (TextView) findViewById(R.id.pick_time_dialog_sure);
        this.cancel = (TextView) findViewById(R.id.pick_time_dialog_cancel);
        this.wheelLayout = (FrameLayout) findViewById(R.id.pick_time_dialog_wheelLayout);
        this.titleTv = (TextView) findViewById(R.id.pick_time_dialog_title);
        messgeTv = (TextView) findViewById(R.id.pick_time_dialog_message);
