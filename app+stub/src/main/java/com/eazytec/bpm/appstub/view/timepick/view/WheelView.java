package com.eazytec.bpm.appstub.view.timepick.view;
...
import com.eazytec.bpm.appstub.view.timepick.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void refreshTextStatus(View oldView, int old) {
		...
		TextView textview= (TextView) oldView.findViewById(R.id.pick_time_wheel_default_text);
		if(old==currentItem){
