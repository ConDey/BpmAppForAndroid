...
/**
 * @author Beckett_W
 * @version Id: BorderTextView, v 0.1 2017/9/19 14:07 Beckett_W Exp $$
 */
public class BorderTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public BorderTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        strokeWidth = ta.getDimensionPixelSize(R.styleable.BorderTextView_borderTextView_strokeWidth, strokeWidth);
        cornerRadius = ta.getDimensionPixelSize(R.styleable.BorderTextView_borderTextView_cornerRadius, cornerRadius);
        strokeColor = ta.getColor(R.styleable.BorderTextView_borderTextView_strokeColor, Color.TRANSPARENT);
        mFollowTextColor = ta.getBoolean(R.styleable.BorderTextView_borderTextView_followTextColor, true);
        ta.recycle();
