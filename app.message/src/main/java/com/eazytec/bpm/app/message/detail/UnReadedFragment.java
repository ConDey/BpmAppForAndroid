...
/**
 * @author Beckett_W
 * @version Id: UnReadedFragment, v 0.1 2017/11/4 9:36 Beckett_W Exp $$
 */
public class UnReadedFragment extends ContractViewFragment<MessageDetailPresenter> implements MessageDetailContract.View {
    ...
    public void loadSuccess(List<MessageDataTObject> messages) {
        ...
        //判断是否存在下一页
        long i = CurrentMessage.getCurrentMessage().getCount("0");//总条数
